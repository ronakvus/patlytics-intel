...
const HIGHLIGHTS = [
  ...
  },
  {
    ...
    priority: "high",
    category: "Partnership",
    title: "Legora formalizes legal-AI implementation partnership with Consilio",
    summary:
      "Legora and global legal-services/eDiscovery firm Consilio announced a formal implementation partnership, with Consilio providing workflow design, governance, training, and change-management services around Legora deployments — formalizing over a year of prior joint client work.",
    whyItMatters:
      "A direct Tier 1 competitor gaining a large-scale services/implementation partner extends its enterprise-deployment reach beyond its own team, a distribution pattern worth watching as Patlytics considers its own services/partner ecosystem.",
    companies: ["Legora"],
    source: "Artificial Lawyer",
    sourceType: "press-release",
...
const COMPETITORS = [
  {
    ...
    employeeCount: "~90 (est.); Tracxn reports a lower 57 as of 2026-06-30, likely reflecting growth since that snapshot for a fast-growing YC-backed startup",
    founded: "2023",
    hq: "San Francisco, CA",
    ...
    weekActivity: [
      ...
      },
      {
        date: "2026-09-05",
        tag: "Hiring",
        title: "Correction: Ashby board never actually narrowed to 8 — still 15 live postings",
  ...
  },
  {
    ...
    weekActivity: [
      ...
      },
      {
        date: "2026-09-13",
        tag: "Hiring",
        title: "Workday IP-services facet API recovers again — clean 18-role roster, correct tenant identified",
...
COMPETITORS.push(
  ...
  stubCompetitor({
    ...
    description: "Atlanta-based Junior builds AI-native patent drafting tooling that works directly inside Microsoft Word, targeting the same drafting workflow Patlytics and Solve Intelligence compete for. Junior's site now also markets a broader \"Junior Universe\" workspace built around its \"JR3\" model — described as letting users explore patent data, study examiners, and map claims/targets beyond the original Word add-in — though no press coverage confirming an exact public-launch date was found.",
  ...
  stubCompetitor({
    ...
    description: "Alt Legal provides AI-assisted docketing software for IP and trademark portfolios, overlapping with Patlytics primarily on the operations/docketing side. Acquired UK-based WebTMS in April 2026 to add global IP portfolio management.",
        employeeCount: "~54 (Tracxn, 2026); LawNext reported ~60 total staff at the time of the April 2026 WebTMS acquisition (22 of WebTMS's 25 staff plus existing Alt Legal team)",
    founded: "2013",
    hq: "New York, NY",
    founders: [
  ...
  stubCompetitor({
    ...
    weekActivity: [
      ...
      },
      {
        date: "2026-09-04",
        tag: "Hiring",
        title: "Opens Head of Mid-Market Sales (London) and Senior Manager, Product Design — Platform",
      ...
      },
      {
        date: "2026-09-10",
        tag: "Product",
        title: "Launches contract review agents built from a team's own past deals",
        body: "New custom review agents turn a legal team's past executed contracts, negotiation guidelines, and playbooks into a dynamic reviewing agent — flagging when playbook positions have fallen behind recently negotiated outcomes and recommending new standard clauses.",
        url: "https://www.harvey.ai/blog/contract-review-agents-in-harvey",
      },
      {
        date: "2026-09-13",
        tag: "Hiring",
        title: "Board unchanged at 325 postings; 4 titles closed, no new senior roles",
  ...
  stubCompetitor({
    ...
    weekActivity: [
      ...
      },
      {
        date: "2026-09-11",
        tag: "Partnership",
        title: "Formalizes legal-AI implementation partnership with Consilio",
  ...
  stubCompetitor({
    ...
    weekActivity: [
      ...
      },
      {
        date: "2026-09-01",
        tag: "Partnership",
        title: "Everlaw partners with Thomson Reuters to bring evidence into CoCounsel Legal",
  ...
  stubCompetitor({
    ...
    weekActivity: [
      ...
      },
      {
        date: "2026-09-04",
        tag: "Hiring",
        title: "Opens Staff IAM Engineer and Enterprise Sales Leader roles",
  ...
  stubCompetitor({
    ...
    hiring: {
      ...
      topRoles: [
        ...
        { title: "Senior Search Engineer", count: 1, url: "https://ipauthor.com/senior-search-engineer-hybrid-search-gen-ai-solr-elastic-search/" },
        { title: "Senior NLP & Generative AI Engineer", count: 1, url: "https://ipauthor.com/senior-nlp-generative-ai-engineer-deep-search-rag-llm-systems/" },
        { title: "Senior Product Manager", count: 1, url: "https://ipauthor.com/senior-product-manager-india-core-product-dev-team/" },
        { title: "Full-Stack Software Engineer", count: 1, url: "https://ipauthor.com/full-stack-software-engineer-brazil-latin-america-us-time-zone-support/" },
      ],
    },
  }),
  stubCompetitor({
...
const NEW_ENTRANTS = [
  ...
  },
  {
    ...
    name: "General Legal",
    threat: "low",
    backing: "$11.5M combined Pre-Seed + Seed (Y Combinator W26, Audacious Ventures)",
    stage: "Seed",
    tagline: "\"Elite AI law firm for high growth companies.\"",
    website: "https://general.legal",
    linkedin: null,
    description:
      "General Legal is an AI-native law firm pairing top-tier attorneys with proprietary AI workflows for commercial, corporate, and employment legal work for startups — general startup/venture legal work, not patent-specific. Offers contract review at $500/contract with a 3-hour turnaround; reported ~$1M ARR within two months of its January 2026 launch. Included for completeness given broader legal-AI budget overlap.",
    foundingTeam: [
      { name: "Ryan Walker", background: "Founder & CEO. Math PhD/software engineer with 10+ years in legal tech; former CTO of Casetext (YC S13, acquired by Thomson Reuters 2023)." },
      { name: "J.P. Mohler", background: "Founder & CPO. Harvard Law; previously at Cooley and WilmerHale representing startups/VCs." },
      { name: "Javed Qadruddin", background: "Founder & CTO. Harvard Law with a deep-learning background; practiced at Fenwick & West, then Casetext and Meta." },
    ],
    hiring: {
      openRoles: 0,
      focus: "No specific open postings found on general.legal/careers or General Legal's YC company page as of 2026-09-05.",
      hiringProfile: "Not visibly hiring publicly as of 2026-09-05.",
    },
    date: "2026-07-12",
  ...
  },
  {
    ...
    linkedin: null,
    description:
      "New York City-based Stratum Industries builds AI agents that work through government-agency application backlogs — permits, licenses, benefits claims — with a named use case for the USPTO's roughly 777,000-application patent-examination backlog; a human officer retains final approval on every decision. Horizontal across government verticals rather than patent-specific, and not itself a drafting/prosecution tool, but included for completeness given the direct USPTO-backlog framing. Note (2026-09-13): the stratumindustries.co domain now 301-redirects to elitehq.ai, and Y Combinator's own company-page fields for this listing now point to that same site — appears to indicate the company has rebranded to \"Elite\" post-YC (same founders); flagged for a closer look, website field left unchanged pending clearer confirmation.",
    foundingTeam: [
  ...
  },
  {
    ...
    name: "Moritz",
    threat: "low",
    backing: "$9M seed (closed in four days, oversubscribed from a $3M target) — 20VC, Y Combinator, Urban Innovation Fund, Inception Fund, Pioneer Fund, Rice Capital, Illusian, Rebel Fund, plus angels including founders from Reddit, Instacart, Dropbox, Gusto, and Cruise",
    stage: "Seed",
    tagline: "Global AI-native law firm offering same-day turnaround on corporate/commercial legal work.",
    website: "https://www.moritzlegal.com",
    linkedin: null,
    description:
      "San Francisco/Oslo-based Moritz (rebranded from \"Arcline\") is an AI-native law firm serving in-house teams: commercial (procurement, MSAs, SOWs), litigation/discovery, privacy, corporate/M&A, real estate, and employment work, at flat fees ($250-$2,500/matter). AI handles roughly 80% of drafting, with human lawyers completing the final 20%. Not patent-specific — included for completeness given general legal-AI budget overlap, in the same category as Newcode/Vector Legal/General Legal/Sandstone already tracked here.",
    foundingTeam: [
      { name: "Pamir Ehsas", background: "Co-Founder & CEO. Lawyer; former outside counsel to OpenAI and Google at a Norwegian law firm." },
      { name: "Stefan Mandaric", background: "Co-Founder & CTO. AI engineer; ex-Fulbright scholar at MIT." },
    ],
    hiring: {
      openRoles: null,
      focus: "Founding Engineer, Founding Commercial Attorney, Founding BDR, and Founding Account Executive roles, per its Y Combinator jobs listing.",
      hiringProfile: "Early-stage founding-level hires across engineering, legal, and GTM.",
    },
    date: "2026-05-05",
...
const WEBINARS = [
  ...
  {
    id: "wb-14",
    title: "How to Prompt AI – University IP Workflows in Action (CLE Webinar)",
    host: "Junior",
    date: "2026-09-29",
    time: "12:00 PM ET",
    format: "Live webinar",
    relevance: "high",
    description: "Direct Tier 1 competitor-hosted CLE session on practical AI implementation in university tech-transfer offices/law clinics, with a live demo. A second run of the same session is scheduled for 2026-10-15.",
    tags: ["Competitor-hosted"],
    url: "https://ipwatchdog.com/event/webinar-junior-2026-09-29-how-to-prompt-ai/",
  },
  {
    id: "wb-15",
  ...
  {
    id: "wb-20",
    title: "Idea Factories: The Engine Behind America's Innovation Economy",
    host: "Council for Innovation Promotion (C4IP)",
    date: "2026-09-23",
    time: "2:30 PM ET",
    format: "Live webinar",
    relevance: "low",
  ...
  {
    id: "wb-23",
    title: "Life Sciences Masters™ 2026 (Fifth Annual)",
    host: "IPWatchdog",
    date: "2026-11-09",
    time: "In-person, Ashburn, VA (IPWatchdog Studios), through Nov 11",
    format: "Conference",
    relevance: "medium",
    description: "Fifth annual in-person life-sciences IP conference at IPWatchdog Studios; full agenda not yet published.",
    tags: ["Conference", "Industry Event"],
    url: "https://ipwatchdog.com/event/life-sciences-masters-2026/",
  },
  {
    id: "wb-24",
    title: "Virtual PTAB Masters 2027",
    host: "IPWatchdog",
    date: "2027-02-01",
    time: "Virtual, through Feb 5",
...
const BLOGS = [
  ...
  {
    id: "blog-58",
    headline: "AI in healthcare: What patent intelligence reveals about your future competitors",
    description: "Clarivate examines what patent-landscape analytics show about competitive AI activity in the healthcare sector.",
    companyId: "clarivate-innography",
    source: "Clarivate",
    date: "2026-08-18",
    relevance: "medium",
    tags: ["Patent Landscape", "AI Patents"],
    url: "https://clarivate.com/intellectual-property/blog/ai-in-healthcare-what-patent-intelligence-reveals-about-your-future-competitors/",
  },
  {
    id: "blog-59",
    headline: "Three Law Librarian Challenges We Spotted at AALL 2026",
    description: "ktMINE recaps AI-adoption skepticism and other challenges law librarians raised at the AALL 2026 conference.",
    companyId: "ktmine",
    source: "ktMINE",
    date: "2026-08-05",
    relevance: "low",
    tags: ["Industry Event", "AI Adoption"],
    url: "https://www.ktmine.com/three-law-librarian-challenges-we-spotted-at-aall-2026/",
  },
  {
    id: "blog-60",
    headline: "How to Review a JCT Contract Amendment",
    description: "Genie AI lays out a seven-step framework for reviewing JCT construction-contract amendments, arguing the amendments (not the standard form) carry the real commercial risk, and pitches AI contract-review tooling to systematically flag deviations.",
    companyId: "genie-ai",
    source: "Genie AI",
    date: "2026-08-17",
    relevance: "low",
    tags: ["Contract Review", "Thought Leadership"],
    url: "https://www.genieai.co/blog/how-to-review-a-jct-contract-amendment",
  },
  {
    id: "blog-61",
    headline: "Creating more value in less time: How the Managing Partner of Harrison LLP became one of Legora's top power users",
    description: "Legora customer-story post profiling how Harrison LLP's Managing Partner uses Legora day-to-day across the firm's legal work.",
    companyId: "legora",
    source: "Legora",
    date: "2026-09-03",
    relevance: "low",
    tags: ["Customer Story"],
    url: "https://legora.com/blog/creating-more-value-in-less-time-how-the-managing-partner-of-harrison-llp-became-one-of-legora-s-top-power-users",
  },
  {
    id: "blog-62",
    headline: "Everlaw and Thomson Reuters CoCounsel Partnership",
    description: "Everlaw announces a partnership letting CoCounsel Legal users pull Everlaw evidence and case data directly into CoCounsel's research workflow.",
    companyId: "cocounsel",
    source: "Everlaw",
    date: "2026-09-01",
    relevance: "medium",
  ...
  {
    id: "blog-63",
    headline: "The AI-Enabled Patent Office – What the USPTO's AI Strategy Means for High-Volume Prosecution",
    description: "DeepIP examines the USPTO's AI strategy and its implications for high-volume patent prosecution workflows.",
    companyId: "deepip",
    source: "DeepIP",
    date: "2026-08-04",
    relevance: "medium",
    tags: ["Thought Leadership", "Regulatory"],
    url: "https://www.deepip.ai/blog/uspto-ai-strategy-patent-examination",
  },
  {
    id: "blog-64",
    headline: "Who captures the value when AI gives patent teams their time back",
    description: "DeepIP recaps a Munich panel discussion on efficiency gains from AI in patent prosecution and who benefits from the time savings.",
    companyId: "deepip",
    source: "DeepIP",
    date: "2026-08-11",
    relevance: "medium",
    tags: ["Thought Leadership"],
    url: "https://www.deepip.ai/blog/ai-efficiency-patent-prosecution-munich-panel-1",
  },
  {
    id: "blog-65",
    headline: "What AI changed between in-house teams and their outside counsel",
    description: "DeepIP recaps a second Munich panel discussion on how AI is changing the relationship between in-house IP teams and outside counsel.",
    companyId: "deepip",
    source: "DeepIP",
    date: "2026-08-12",
    relevance: "medium",
    tags: ["Thought Leadership"],
    url: "https://www.deepip.ai/blog/ai-trust-in-house-outside-counsel-munich-panel-2",
  },
  {
    id: "blog-66",
    headline: "AI Patent Search Market Size, Growth & Trends (2026 Report)",
    description: "XLSCOUT publishes market-sizing and growth-trend content on the AI patent search market.",
    companyId: "xlscout",
    source: "XLSCOUT",
    date: "2026-09-01",
    relevance: "low",
    tags: ["Market Data", "Content Marketing"],
    url: "https://xlscout.ai/ai-patent-search-market-size-growth-trends-2026-report/",
  },
  {
    id: "blog-67",
    headline: "Patent Portfolio Monetization Strategies",
    description: "XLSCOUT publishes educational content on strategies for monetizing patent portfolios.",
    companyId: "xlscout",
    source: "XLSCOUT",
    date: "2026-09-01",
    relevance: "low",
  ...
  {
    id: "blog-106",
    headline: "Clarivate and Audity Advance Global Sound Mark Protection",
    description: "Clarivate partnered with Audity GmbH to offer sound-mark trademark protection (similarity checks, an analytics database, and ongoing monitoring across EUIPO, WIPO, and other jurisdictions), combining Clarivate's trademark search/watch tools with Audity's sonic-branding technology.",
    companyId: "clarivate-innography",
    source: "Clarivate",
    date: "2026-09-07",
    relevance: "medium",
    tags: ["Partnership", "Trademark"],
    url: "https://clarivate.com/intellectual-property/blog/clarivate-audity-sound-mark-protection/",
  },
  {
    id: "blog-107",
    headline: "Contract Review Agents That Turn Past Deals Into Better Outcomes",
    description: "Harvey introduced custom review agents that turn a legal team's past executed contracts, negotiation guidelines, and playbooks into a dynamic reviewing agent, flagging when playbook positions have fallen behind recently negotiated outcomes.",
    companyId: "harvey",
    source: "Harvey",
    date: "2026-09-10",
    relevance: "critical",
    tags: ["Product Launch", "Contract Review"],
    url: "https://www.harvey.ai/blog/contract-review-agents-in-harvey",
  },
  {
    id: "blog-108",
    headline: "Delegate File Search and Organization to Harvey",
    description: "Harvey product post on delegating document file search and organization tasks to its agents.",
    companyId: "harvey",
    source: "Harvey",
    date: "2026-09-08",
    relevance: "high",
    tags: ["Product"],
    url: "https://www.harvey.ai/blog/agentic-vault-search-and-organization",
  },
  {
    id: "blog-110",
    headline: "How Harrison LLP's Managing Partner Became One of Legora's Top Power Users",
    description: "Legora customer profile on Harrison LLP's Managing Partner creating more value in less time as a top power user of the platform.",
    companyId: "legora",
    source: "Legora",
    date: "2026-09-03",
    relevance: "medium",
  ...
  {
    id: "blog-111",
    headline: "Legora AI Day at Bucerius Law School",
    description: "Recap of a Legora-hosted AI Day event at Bucerius Law School in Hamburg.",
    companyId: "legora",
    source: "Legora",
    date: "2026-08-19",
    relevance: "low",
  ...
  },
  {
    id: "blog-112",
    headline: "Invention Harvesting vs. Invention Disclosure: What IP Teams Get Wrong",
    description: "IP Copilot blog post distinguishing invention harvesting from invention disclosure and common IP-team missteps between the two.",
    companyId: "ip-copilot",
    source: "IP Copilot",
    date: "2026-09-03",
    relevance: "medium",
    tags: ["Thought Leadership"],
    url: "https://blog.ipcopilot.ai/invention-harvesting-vs-invention-disclosure",
  },
  {
    id: "blog-113",
    headline: "AI Tools for IP Teams: How to Evaluate What Actually Matters",
    description: "IP Copilot blog post offering an evaluation framework for AI tools aimed at IP teams.",
    companyId: "ip-copilot",
    source: "IP Copilot",
    date: "2026-08-27",
    relevance: "medium",
    tags: ["Thought Leadership"],
    url: "https://blog.ipcopilot.ai/2026/08/27/ai-tools-for-ip-teams/",
  },
  {
    id: "blog-114",
    headline: "Invention Harvesting Is Not What You Think It Is",
    description: "IP Copilot blog post reframing what invention harvesting means for corporate IP teams.",
    companyId: "ip-copilot",
    source: "IP Copilot",
    date: "2026-08-18",
    relevance: "low",
    tags: ["Thought Leadership"],
    url: "https://blog.ipcopilot.ai/invention-harvesting-is-not-what-you-think",
  },
  {
    id: "blog-115",
    headline: "The Patent Estate Problem: Why Litigation Finance Is the Only Preservation Tool American Inventors Actually Have",
    description: "IPWatchdog contributor argues that absent reforms like the PREVAIL Act and RESTORE Patent Rights Act, litigation finance remains the only mechanism protecting a solo inventor's patent estate value for their heirs, tying the argument to live funder-disclosure debates.",
    companyId: "industry",
    source: "IPWatchdog",
    date: "2026-09-10",
    relevance: "medium",
    tags: ["Patent Strategy", "Litigation Finance"],
    url: "https://ipwatchdog.com/2026/09/10/patent-estate-problem-why-litigation-finance-only-preservation-tool-american-inventors-actually-have/",
  },
  {
    id: "blog-116",
    headline: "GC-Backed Fund GCVC Launches, Backing 2 Legal Startups",
    description: "A new venture fund, GCVC, launched backed by 50+ sitting general counsels with Wilson Sonsini as its first law-firm investor; its first two portfolio companies are Sandstone and Stilta, both already tracked in New Market Entrants.",
    companyId: "industry",
    source: "ABA Journal",
    date: "2026-09-09",
    relevance: "medium",
    tags: ["Funding", "Industry Trend"],
    url: "https://www.abajournal.com/news/article/new-legal-tech-vc-fund-consisting-of-general-counsels-and-wilson-sonsini-launches",
  },
  {
    id: "blog-117",
    headline: "Casepoint Launches Casepoint IQ, an AI Framework Spanning Its Full Platform",
    description: "eDiscovery platform Casepoint unveiled Casepoint IQ, unifying new autonomous/assistive agents, its CaseAssist predictive coding, and an MCP server under one governance/audit layer.",
    companyId: "industry",
    source: "LawNext (LawSites)",
    date: "2026-09-09",
    relevance: "low",
    tags: ["Product Launch", "Agentic AI"],
    url: "https://www.lawnext.com/2026/09/casepoint-launches-casepoint-iq-an-ai-framework-spanning-its-full-platform-from-new-autonomous-agents-and-assistive-ai-to-legacy-predictive-coding.html",
  },
  {
    id: "blog-118",
    headline: "Iprova's CEO Featured in Roland Berger's Think:Act Magazine",
    description: "Iprova founder/CEO Julian Nolan was profiled in Roland Berger's Think:Act publication.",
    companyId: "iprova",
    source: "Roland Berger (Think:Act)",
    date: "2026-08-05",
    relevance: "low",
    tags: ["PR"],
